var PunMovArr = JSON.parse(localStorage.getItem('PunMov')) || []; 
// console.log(webseriesArr);


function displayWebseries(PunMovArr) {
    document.querySelector(".more_container").innerHTML = "";

    PunMovArr.map(function (item, index) {
...
function sortfunc(){
    ...
    filterData = PunMovArr.filter(function (elem) {
